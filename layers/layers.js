...
var lyr_C_1 = new ol.layer.Image({
                            opacity: 1,
                            title: 'Cумма температур почвы >10 градусов <br> <img src= "leg_temp.png" wight= "120px">',
...
lyr_T_2.set('fieldAliases', {'name': 'Округ', 'Co': 'Co, мг/кг', 'Cu': 'Cu, мг/кг', 'Zn': 'Zn, мг/кг', });
lyr_P_3.set('fieldAliases', {'name': 'Округ', 'area': 'Площадь общая, га', 'plow': 'Площать обрабатывемая, га', });
